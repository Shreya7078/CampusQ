      ...
      <nav className="bg-gradient-to-r from-indigo-900 to-purple-600 p-4 flex justify-between items-center fixed w-full top-0 z-10 shadow-lg">
        ...
        <div className="flex items-center space-x-4">
          ...
          <div className="md:hidden">
            <button
              id="sidebar-toggle"
              onClick={onSidebarToggle} // Added functionality to toggle sidebar
          ...
          <div className="hidden md:flex items-center">
            <div className="relative group px-8">
              ...
              <div className="absolute right-0 mt-2 w-32 bg-white text-indigo-700 rounded-md shadow-lg hidden group-hover:block">
