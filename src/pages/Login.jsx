...
const Login = () => {
  ...
  const handleLogin = (e) => {
    ...
    const isValid = 
      (email === 'shreya@example.com' && password === 'password123' && role === 'student') ||
      ...
      <div className="flex-1 flex items-center justify-center pt-16">
        <div className="bg-white p-5 sm:p-6 rounded-xl shadow-2xl w-full max-w-sm transform transition-all duration-300 hover:shadow-3xl">
          ...
          <form onSubmit={handleLogin} className="space-y-5 sm:space-y-6">
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-2 sm:left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} sm:size={18} />
                <input
                  type="email"
                  value={email}
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-2 sm:left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={16} sm:size={18} />
                <input
                  type="password"
                  value={password}
          ...
          <div className="mt-4 sm:mt-6 text-center">
            <p className="text-gray-600 text-sm sm:text-sm">Don't have an account? <span onClick={handleSignUpClick} className="text-indigo-700 text-md hover:text-indigo-800 hover:underline cursor-pointer">Sign Up</span></p>
          </div>
        </div>
      </div>
